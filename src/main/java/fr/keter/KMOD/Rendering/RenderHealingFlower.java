...
import fr.keter.KMOD.Models.ModelHealingFlower;
...
public class RenderHealingFlower extends TileEntitySpecialRenderer {
   private final ModelHealingFlower model = new ModelHealingFlower();

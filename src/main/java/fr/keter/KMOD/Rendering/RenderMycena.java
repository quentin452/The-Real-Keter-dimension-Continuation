...
import fr.keter.KMOD.Models.ModelMycena;
...
public class RenderMycena extends TileEntitySpecialRenderer {
   private final ModelMycena model = new ModelMycena();
   ...
   public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
      ...
      ResourceLocation textures = new ResourceLocation("Real Kether:textures/3DBlocks/Mycena.png");

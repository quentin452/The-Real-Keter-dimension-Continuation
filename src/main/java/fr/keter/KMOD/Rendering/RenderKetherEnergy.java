...
public class RenderKetherEnergy extends Render {
   private Item field_94151_a;
   private int field_94150_f;

   public RenderKetherEnergy(Item p_i1259_1_, int p_i1259_2_) {
      this.field_94151_a = p_i1259_1_;
      this.field_94150_f = p_i1259_2_;
   }

   public RenderKetherEnergy(Item p_i1260_1_) {
      this(p_i1260_1_, 0);
   }

   public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
      IIcon iicon = this.field_94151_a.getIcon(new ItemStack(this.field_94151_a), 0);
      if (iicon != null) {
         GL11.glPushMatrix();

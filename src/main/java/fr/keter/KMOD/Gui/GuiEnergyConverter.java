...
public class GuiEnergyConverter extends GuiContainer {
   private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("Real Kether:textures/gui/container/Energy Converter.png");
   private TileEntityEnergyConverter tileFurnace;

   public GuiEnergyConverter(InventoryPlayer par1InventoryPlayer, TileEntityEnergyConverter par2TileEntityEnergyConverter) {
      super(new ContainerEnergyConverter(par1InventoryPlayer, par2TileEntityEnergyConverter));
   ...
   protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
      ...
      this.drawTexturedModalRect(k + 27, l + 3, 0, 166, i1, 16);
   }
}

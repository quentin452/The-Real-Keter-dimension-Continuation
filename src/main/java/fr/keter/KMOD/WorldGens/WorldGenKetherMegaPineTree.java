...
import fr.keter.KMOD.Blocks.BlockKetherSapling;
...
public class WorldGenKetherMegaPineTree extends KetherGenHugeTreeBase {
   private boolean field_150542_e;

   public WorldGenKetherMegaPineTree(boolean p_i45457_1_, boolean p_i45457_2_) {
      ...
      if (!this.func_150537_a(p_76484_1_, p_76484_2_, p_76484_3_, p_76484_4_, p_76484_5_, l)) {
         ...
         for(int i1 = 0; i1 < l; ++i1) {
            ...
            if (block.isAir(p_76484_1_, p_76484_3_, p_76484_4_ + i1, p_76484_5_) || block.isLeaves(p_76484_1_, p_76484_3_, p_76484_4_ + i1, p_76484_5_)) {
               this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + i1, p_76484_5_, KMOD_Main.KetherLog, this.woodMetadata);
            }
            ...
            if (i1 < l - 1) {
               ...
               if (block.isAir(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + i1, p_76484_5_) || block.isLeaves(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + i1, p_76484_5_)) {
                  this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + i1, p_76484_5_, KMOD_Main.KetherLog, this.woodMetadata);
               }
               ...
               if (block.isAir(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + i1, p_76484_5_ + 1) || block.isLeaves(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + i1, p_76484_5_ + 1)) {
                  this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + i1, p_76484_5_ + 1, KMOD_Main.KetherLog, this.woodMetadata);
               }
               ...
               if (block.isAir(p_76484_1_, p_76484_3_, p_76484_4_ + i1, p_76484_5_ + 1) || block.isLeaves(p_76484_1_, p_76484_3_, p_76484_4_ + i1, p_76484_5_ + 1)) {
                  this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + i1, p_76484_5_ + 1, KMOD_Main.KetherLog, this.woodMetadata);
               }
            }
         }
   ...
   private void func_150540_a(World p_150540_1_, int p_150540_2_, int p_150540_3_, int p_150540_4_) {
      for(int l = p_150540_3_ + 2; l >= p_150540_3_ - 3; --l) {
         ...
         if (block.canSustainPlant(p_150540_1_, p_150540_2_, l, p_150540_4_, ForgeDirection.UP, (BlockKetherSapling)KMOD_Main.KetherSapling)) {

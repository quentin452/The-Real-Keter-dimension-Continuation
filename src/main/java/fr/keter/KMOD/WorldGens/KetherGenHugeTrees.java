...
public class KetherGenHugeTrees extends KetherGenHugeTreeBaseNormal {
   public KetherGenHugeTrees(boolean p_i45456_1_, int p_i45456_2_, int p_i45456_3_, int p_i45456_4_, int p_i45456_5_) {
   ...
   public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_) {
      ...
      if (!this.func_150537_a(p_76484_1_, p_76484_2_, p_76484_3_, p_76484_4_, p_76484_5_, l)) {
         ...
         int l2;
         for(l2 = p_76484_4_ + l - 2 - p_76484_2_.nextInt(4); l2 > p_76484_4_ + l / 2; l2 -= 2 + p_76484_2_.nextInt(4)) {
            ...
            for(l1 = 0; l1 < 5; ++l1) {
               ...
               this.setBlockAndNotifyAdequately(p_76484_1_, j1, l2 - 3 + l1 / 2, k1, KMOD_Main.KetherLog, this.woodMetadata);
            }

            l1 = 1 + p_76484_2_.nextInt(2);
            int i2 = l2;

            for(int j2 = l2 - l1; j2 <= i2; ++j2) {
               int k2 = j2 - i2;
         ...
         for(l2 = 0; l2 < l; ++l2) {
            ...
            if (block.isAir(p_76484_1_, p_76484_3_, p_76484_4_ + l2, p_76484_5_) || block.isLeaves(p_76484_1_, p_76484_3_, p_76484_4_ + l2, p_76484_5_)) {
               this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + l2, p_76484_5_, KMOD_Main.KetherLog, this.woodMetadata);
               if (l2 > 0) {
            ...
            if (l2 < l - 1) {
               ...
               if (block.isAir(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + l2, p_76484_5_) || block.isLeaves(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + l2, p_76484_5_)) {
                  this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + l2, p_76484_5_, KMOD_Main.KetherLog, this.woodMetadata);
                  if (l2 > 0) {
               ...
               if (block.isAir(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + l2, p_76484_5_ + 1) || block.isLeaves(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + l2, p_76484_5_ + 1)) {
                  this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + l2, p_76484_5_ + 1, KMOD_Main.KetherLog, this.woodMetadata);
                  if (l2 > 0) {
               ...
               if (block.isAir(p_76484_1_, p_76484_3_, p_76484_4_ + l2, p_76484_5_ + 1) || block.isLeaves(p_76484_1_, p_76484_3_, p_76484_4_ + l2, p_76484_5_ + 1)) {
                  this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + l2, p_76484_5_ + 1, KMOD_Main.KetherLog, this.woodMetadata);
                  if (l2 > 0) {
                     if (p_76484_2_.nextInt(3) > 0 && p_76484_1_.isAirBlock(p_76484_3_ - 1, p_76484_4_ + l2, p_76484_5_ + 1)) {

...
public class KetherGenNormalTrees extends KetherAbstractTree {
   private final int minTreeHeight;
   private final boolean vinesGrow;
   private final int metaWood;
   private final int metaLeaves;

   public KetherGenNormalTrees(boolean p_i2027_1_) {
      this(p_i2027_1_, 8, 0, 0, false);
   }

   public KetherGenNormalTrees(boolean p_i2028_1_, int p_i2028_2_, int p_i2028_3_, int p_i2028_4_, boolean p_i2028_5_) {
      super(p_i2028_1_);
            ...
            if (p_76484_4_ >= 256 - l - 1) {
                     ...
                     for(int k2 = p_76484_5_ - l1; k2 <= p_76484_5_ + l1; ++k2) {
                        ...
                        if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || p_76484_2_.nextInt(2) != 0 && i3 != 0) {
                           ...
                           if (block1.isAir(p_76484_1_, i2, k1, k2) || block1.isLeaves(p_76484_1_, i2, k1, k2)) {
                              this.setBlockAndNotifyAdequately(p_76484_1_, i2, k1, k2, KMOD_Main.KetherBlueLeaves, this.metaLeaves);
                           }
                        }
                     }
                  }
               ...
               for(k1 = 0; k1 < l; ++k1) {
                  ...
                  if (block.isAir(p_76484_1_, p_76484_3_, p_76484_4_ + k1, p_76484_5_) || block.isLeaves(p_76484_1_, p_76484_3_, p_76484_4_ + k1, p_76484_5_)) {
                     this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + k1, p_76484_5_, KMOD_Main.KetherLog, this.metaWood);

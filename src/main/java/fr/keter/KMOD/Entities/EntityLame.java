...
public class EntityLame extends EntityAnimal {
   public EntityLame(World p_i1683_1_) {
      super(p_i1683_1_);
   ...
   protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
      ...
      int k;
      for(k = 0; k < j; ++k) {
         this.dropItem(KMOD_Main.LameMeat, 2);
      }

      j = this.rand.nextInt(3) + 1 + this.rand.nextInt(1 + p_70628_2_);

      for(k = 0; k < j; ++k) {
         int c1 = this.rand.nextInt(4);
         int c = this.rand.nextInt(5);
         if (this.isBurning()) {
            this.dropItem(KMOD_Main.LameMeat, c1);
         } else {
            this.dropItem(KMOD_Main.LameMeat, c1);
            this.dropItem(Item.getItemFromBlock(Blocks.wool), c);
         }
      }
   ...
   public boolean isBreedingItem(ItemStack p_70877_1_) {
      return p_70877_1_ != null && p_70877_1_.getItem() == Item.getItemFromBlock(Blocks.hay_block);
   }
   ...
   public EntityLame createChild(EntityAgeable p_90011_1_) {
      EntityLame el = new EntityLame(this.worldObj);
      el.setSize(0.5F, 0.5F);
      return el;
   }
}

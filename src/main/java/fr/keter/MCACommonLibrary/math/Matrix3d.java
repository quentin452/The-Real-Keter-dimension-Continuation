...
public class Matrix3d implements Serializable, Cloneable {
   ...
   public final void setElement(int row, int column, double value) {
      ...
      case 0:
         ...
         case 2:
            ...
            return;
         default:
            throw new ArrayIndexOutOfBoundsException("PROBLEM!!! Matrix3d0");
         }
      case 1:
         switch(column) {
         case 0:
   ...
   public final double getElement(int row, int column) {
      ...
      case 0:
         ...
         case 2:
            return this.m02;
         default:
            throw new ArrayIndexOutOfBoundsException("PROBLEM!!! Matrix3d1");
         }
      case 1:
         switch(column) {
         case 0:
   ...
   public final void getRow(int row, Vector3f v) {
      if (row == 0) {
         ...
         if (row != 2) {
            throw new ArrayIndexOutOfBoundsException("PROBLEM!!! Matrix3d2");
         }
   ...
   public final void getColumn(int column, Vector3f v) {
      if (column == 0) {
         ...
         if (column != 2) {
            throw new ArrayIndexOutOfBoundsException("PROBLEM!!! Matrix3d4");
         }
   ...
   public final void setRow(int row, double x, double y, double z) {
      ...
      case 2:
         ...
         break;
      default:
         throw new ArrayIndexOutOfBoundsException("PROBLEM!!! Matrix3d6");
      }
   ...
   public final void setColumn(int column, double x, double y, double z) {
      ...
      case 2:
         ...
         break;
      default:
         throw new ArrayIndexOutOfBoundsException("PROBLEM!!! Matrix3d9");
      }
   ...
   static boolean luDecomposition(double[] matrix0, int[] row_perm) {
      ...
      for(j = 0; j < 3; ++j) {
         ...
         if (imax < 0) {
            throw new RuntimeException("PROBLEM!!! Matrix3d13");
         }

...
public class EntityTestParticle1 extends EntityFX {
   float reddustParticleScale;

   public EntityTestParticle1(World par1World, double par2, double par4, double par6, float par8, float par9, float par10) {
      this(par1World, par2, par4, par6, 1.0F, par8, par9, par10);
   }

   public EntityTestParticle1(World par1World, double par2, double par4, double par6, float par8, float par9, float par10, float par11) {
   ...
   public void renderParticle(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7) {
      ...
      this.setRBGColorF(129.0F, 223.0F, 230.0F);

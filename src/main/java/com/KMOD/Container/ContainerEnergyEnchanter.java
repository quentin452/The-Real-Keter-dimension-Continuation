...
public class ContainerEnergyEnchanter extends Container {
   private TileEntityEnergyEnchanter tileFurnace;
   private int lastCookTime;
   private int lastBurnTime;
   private int lastItemBurnTime;

   public ContainerEnergyEnchanter(InventoryPlayer p_i1812_1_, TileEntityEnergyEnchanter p_i1812_2_) {
      this.tileFurnace = p_i1812_2_;
      this.addSlotToContainer(new Slot(p_i1812_2_, 0, 8, 4));
      this.addSlotToContainer(new Slot(p_i1812_2_, 1, 8, 64));
      this.addSlotToContainer(new SlotFurnace(p_i1812_1_.player, p_i1812_2_, 2, 152, 9));
      this.addSlotToContainer(new Slot(p_i1812_2_, 3, 77, 29));
   ...
   public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_) {
      ...
      if (slot != null && slot.getHasStack()) {
         ...
         if (p_82846_2_ == 2) {
            ...
            } else if (TileEntityEnergyEnchanter.isItemFuel(itemstack1)) {

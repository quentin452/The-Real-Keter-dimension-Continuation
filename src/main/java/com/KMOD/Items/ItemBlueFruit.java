...
public class ItemBlueFruit extends ItemFood implements IPlantable {
   private Block field_150908_b;
   private Block soilId;
   Block field_150935_a;

   public ItemBlueFruit(int p_i45351_1_, float p_i45351_2_, Block p_i45351_3_, Block p_i45351_4_, String Name) {
      super(p_i45351_1_, p_i45351_2_, false);
      this.field_150935_a = KMOD_Main.BlueFruitBlock;

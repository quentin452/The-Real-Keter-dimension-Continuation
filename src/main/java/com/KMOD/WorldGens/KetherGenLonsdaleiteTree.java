...
public class KetherGenLonsdaleiteTree extends KetherAbstractTree {
   ...
   public KetherGenLonsdaleiteTree(boolean p_i2008_1_) {
      super(p_i2008_1_);
   }
   ...
   void generateLeafNode(int p_76491_1_, int p_76491_2_, int p_76491_3_) {
      ...
      for(int i1 = p_76491_2_ + this.leafDistanceLimit; l < i1; ++l) {
         ...
         this.func_150529_a(p_76491_1_, l, p_76491_3_, f, (byte)1, KMOD_Main.KetherLonsdaleiteLeaves);
      }
   ...
   void generateTrunk() {
      ...
      this.func_150530_a(aint, aint1, KMOD_Main.KetherLonsdaleiteLog);
      if (this.trunkSize == 2) {
         int var10002 = aint[0]++;
         var10002 = aint1[0]++;
         this.func_150530_a(aint, aint1, KMOD_Main.KetherLonsdaleiteLog);
   ...
   void generateLeafNodeBases() {
      ...
      for(int[] aint = new int[]{this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i) {
         ...
         if (this.leafNodeNeedsBase(k)) {
            this.func_150530_a(aint, aint2, KMOD_Main.KetherLonsdaleiteLog);
         }
      }

...
public class WorldGenMinableKether extends WorldGenerator {
   private Block field_150519_a;
   private int numberOfBlocks;
   private Block field_150518_c;
   private int mineableBlockMeta;

   public WorldGenMinableKether(Block p_i45459_1_, int p_i45459_2_) {
      this(p_i45459_1_, p_i45459_2_, KMOD_Main.KetherStone);
   }

   public WorldGenMinableKether(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_) {
      this.field_150519_a = p_i45460_1_;
      this.numberOfBlocks = p_i45460_2_;
      this.field_150518_c = p_i45460_3_;
   }

   public WorldGenMinableKether(Block block, int meta, int number, Block target) {
   ...
   public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_) {
      ...
      for(int l = 0; l <= this.numberOfBlocks; ++l) {
         ...
         double d10 = (double)(MathHelper.sin((float)l * 3.1415927F / (float)this.numberOfBlocks) + 1.0F) * d9 + 1.0D;
         double d11 = (double)(MathHelper.sin((float)l * 3.1415927F / (float)this.numberOfBlocks) + 1.0F) * d9 + 1.0D;
               ...
               for(int l2 = j1; l2 <= i2; ++l2) {
                  ...
                  if (d12 * d12 + d13 * d13 < 1.0D) {
                     for(int i3 = k1; i3 <= j2; ++i3) {
                        ...
                        if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && p_76484_1_.getBlock(k2, l2, i3).isReplaceableOreGen(p_76484_1_, k2, l2, i3, this.field_150518_c)) {

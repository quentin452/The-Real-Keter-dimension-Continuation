...
public class BlockKetherCrystals extends BlockContainer {
   public BlockKetherCrystals() {
      super(Material.iron);
   ...
   public boolean canBlockStay(World world, int x, int y, int z) {
      return world.getBlock(x, y - 1, z) != this && world.getBlock(x, y - 1, z) != Blocks.air && world.getBlock(x, y - 1, z) != Blocks.water && world.getBlock(x, y - 1, z) != Blocks.lava && world.getBlock(x, y - 1, z) != Blocks.waterlily;
   }

...
public class EntityDarkEnergy extends Entity {
   public int field_92057_e = 4;
   ...
   public EntityDarkEnergy(World p_i1759_1_) {
      super(p_i1759_1_);
   ...
   public EntityDarkEnergy(World p_i1760_1_, double p_i1760_2_, double p_i1760_4_, double p_i1760_6_, double p_i1760_8_, double p_i1760_10_, double p_i1760_12_) {
      super(p_i1760_1_);
      this.setSize(1.0F, 1.0F);
   ...
   public EntityDarkEnergy(World p_i1761_1_, EntityLivingBase p_i1761_2_, double p_i1761_3_, double p_i1761_5_, double p_i1761_7_) {
      super(p_i1761_1_);
   ...
   protected void onImpact(MovingObjectPosition p_70227_1_) {
      if (!this.worldObj.isRemote) {
         if (p_70227_1_.entityHit != null && !(p_70227_1_.entityHit instanceof EntityCaveGuardian)) {
            p_70227_1_.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, this.shootingEntity), 8.0F);
         }
